...
export default function IndicatorClient({ indicatorCode }: { indicatorCode: string }) {
    ...
    <div className="max-w-7xl space-y-6">
      ...
      {loading && (
        <div className="space-y-4">
          <div className="rounded-2xl p-6 h-32 animate-pulse bg-slate-200" />
          <div className="rounded-xl border border-slate-200 p-5 h-64 animate-pulse bg-slate-100" />
        </div>
      )}
